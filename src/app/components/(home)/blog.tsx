...
const BlogPage = async () => {
    ...
    return (
        <div>
            <div className='hidden row-span-1 lg:grid grid-cols-2 lg:grid-cols-5 gap-x-5 px-5 bg-light overflow-y-clip'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex flex-col gap-y-16'>
                            <div className='flex flex-col lg:flex-row w-full justify-between'>
                                {/* XL screen blogs */}
                                <div className='hidden xl:grid xl:grid-cols-4 w-full justify-between'>
