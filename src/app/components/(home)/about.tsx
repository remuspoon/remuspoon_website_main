        ...
        <div className='bg-gray max-w-screen overflow-x-hidden'>
            <div className='flex flex-col justify-center items-center'>
                <div className='py-20 lg:py-32'>
                    <h1 id='about' className='text-xl lg:text-2xl font-abril text-light tracking-tighter drop-shadow-md'>ABOUT
                        <span className='text-main'>.</span>
                    </h1>
                </div>
                <div className='grid grid-cols-12 gap-x-5 px-5 w-screen'>
                    <div className='col-start-2 col-span-10 grid grid-rows-3 pb-36 gap-y-72 mb-32'>
