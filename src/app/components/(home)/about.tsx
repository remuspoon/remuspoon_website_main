        ...
        <div className='bg-gray w-full overflow-hidden' ref={containerRef}>
            <div className='flex flex-col justify-center items-center'>
                <div className='py-10 lg:py-32'>
                    ...
                    <h1 
                        id='about' 
                        className='lg:hidden text-[5rem] md:text-[8rem] font-abril text-light tracking-tighter drop-shadow-md'
                    >
                        ABOUT
                    ...
                    <motion.h1 
                        ...
                        className='hidden lg:block text-2xl font-abril text-light tracking-tighter drop-shadow-md'
                    >
                        ABOUT
                        <span className='text-main'>.</span>
                    </motion.h1>
                </div>
                <div className='grid grid-cols-12 gap-x-5 px-5  max-w-[1440px] mx-auto pb-32'>
                    ...
                    {/* Small and Medium Screen About Page - Static */}
